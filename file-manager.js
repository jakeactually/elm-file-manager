...
var _user$project$FileManager_View$renderFileThumb = F3(
	function (fileApi, thumbService, fullName) {
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$img,
					{
						...
						_0: _elm_lang$html$Html_Attributes$src(
							A2(_elm_lang$core$Basics_ops['++'], thumbService, fullName)),
						_1: {
							ctor: '::',
			...
			{
				ctor: '::',
				_0: _user$project$FileManager_Util$icon2('insert_drive_file'),
				_1: {ctor: '[]'}
			});
	});
var _user$project$FileManager_View$renderThumb = F4(
	function (thumbService, fileApi, dir, _p7) {
		...
		return _p8.isDir ? A2(
			...
			{
				ctor: '::',
				_0: _user$project$FileManager_Util$icon2('folder'),
				_1: {ctor: '[]'}
			}) : A3(
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('fluid'),
											_1: {ctor: '[]'}
										},
										A2(
											_elm_lang$core$Basics_ops['++'],
